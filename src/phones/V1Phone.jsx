...
const DEALS = [
  ...
  { id: 6, brand: 'Volaris', discount: '10% OFF', detail: 'Vuelos nacionales', dist: '', rating: 4.1, cat: '✈️ Viajes', catKey: 'viajes', lat: 19.4370, lng: -99.1250, image: 'https://images.unsplash.com/photo-1436491865332-7a61a109db05?w=400&h=200&fit=crop', description: 'Descuento exclusivo en vuelos nacionales comprando desde la app de Volaris con tu código DescluB.', expiry: '45 días', redeemed: 89, terms: ['Compra en volaris.com o app', 'Código único por membresía', 'Sujeto a disponibilidad de tarifas', 'No aplica en temporada alta'] },
