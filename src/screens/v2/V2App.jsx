...
function BenefitsTab({ onDealClick }) {
  const categories = [
    { title: 'Ofertas de Entretenimiento', desc: 'Cine, eventos, espectáculos y más', image: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=600&h=300&fit=crop', deals: DEALS.filter(d => d.cat === 'Entretenimiento' || d.cat === 'Cine') },
